    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('list-products') }}" :active="request()->routeIs('list-products')">
                        {{ __('Sản Phẩm') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('list-categories') }}" :active="request()->routeIs('list-categories')">
                        {{ __('Danh Mục') }}
                    </x-jet-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('list-customers') }}" :active="request()->routeIs('list-customers')">
                        {{ __('Khách hàng') }}
                    </x-jet-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('list-users') }}" :active="request()->routeIs('list-users')">
                        {{ __('Users') }}
                    </x-jet-nav-link>
                </div>
